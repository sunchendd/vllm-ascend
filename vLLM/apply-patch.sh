...
wget https://artifactrepo.wux-g.tools.xfusion.com/artifactory/opensource_general/vllm/0.12.0/package/vllm-0.12.0.tar.gz  --no-check-certificate
# 提取到指定目录，去掉顶层目录
tar -xzf vllm-0.12.0.tar.gz -C "$extract_dir" --strip-components=1
